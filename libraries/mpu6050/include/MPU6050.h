...
#define I2C_INFORMATION_S_
    ...
    typedef struct mpu6050
    {
        ...
        struct mpu6050_offset_data of; // Offset values for readings 
    ...
    /**
     * @brief Finds offset values of gyroscope by using a PI algorithm that 
     * repeats n times
     * 
     * @param mpu6050_t* self: Reference to itself
     * @param uint8_t n: Amount that loops for the PI algorithm
     */
